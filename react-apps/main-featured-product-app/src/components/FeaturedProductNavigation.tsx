...
const FeaturedProductNavigation: React.FC<FeaturedProductNavigationProps> = ({
  ...
  const [activatingCategory, setActiveCategory] = useState(DEFAULT_ACTIVE_CATEGORY);
  ...
  <div className="featured__controls">
    <ul>
      <li className={categoryClassName(DEFAULT_ACTIVE_CATEGORY)}
        onClick={() => activeCategory(DEFAULT_ACTIVE_CATEGORY)}>All</li>
      {categories.map(c => (
        <li key={c.id}
