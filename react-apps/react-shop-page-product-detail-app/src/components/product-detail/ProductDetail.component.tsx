  ...
  useEffect(() => {
    ShopDetailService.getProductById(id)
      .then((data) => {
        ...
        setActiveImage(data.images_Urls_Array[0]);
      })
      .catch((exception) => {
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6">
              <div className="product__details__pic">
                ...
                <div className={Styles.product__details__pic__slider}>
                  {shopDetailInfo.images_Urls_Array?.length && (
                    <OwlCarousel
                      className="owl-theme"
                      loop
                      margin={10}
                      ...
                      autoPlay={true}
                    >
                      {shopDetailInfo.images_Urls_Array.map((url, index) => (
                        <div
                          key={index}
                          className="item"
            ...
            <div className="col-lg-6 col-md-6">
              <div className={Styles.product__details__text}>
                ...
                <a href="#" className={"primary-btn " + Styles["primary-btn"]}>
                  ADD TO CARD
                </a>
